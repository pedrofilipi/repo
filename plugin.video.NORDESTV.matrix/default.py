...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]:::[/COLOR][COLOR white]BEM-VINDOS AO NORDESTV[/COLOR][COLOR white]:::[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
...
url_origem = 'https://bitbucket.org/gpjavahtml/gpjavahtml/raw/master/ndtnew'
try:
